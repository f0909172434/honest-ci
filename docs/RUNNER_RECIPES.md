...
- uses: actions/setup-node@820762786026740c76f36085b0efc47a31fe5020 # v7
  with:
    ...
    cache: npm
- run: npm ci
- uses: f0909172434/honest-ci@v1.0.2
  with:
...
Prefer wrapping the command when possible. On the default branch, generate fresh reports and the baseline together with `npx honest-ci baseline write -- <test-command>`, then review and commit the baseline. Install the reproducible stable package with `honest-ci@1.0.2`.
